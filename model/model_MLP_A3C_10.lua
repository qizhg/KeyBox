...
function g_build_model()
    ...
    local model_monitoring = nn.gModule({input_monitoring, Gumbel_noise}, 
                             {out_monitoring})

    local model_acting = nn.gModule({input_acting, comm_in}, 
    						 {action_prob_acting, baseline_acting})

    return {model_monitoring, model_acting}
end
