...
function g_build_model()
    ...
    -----final
    local final_lstm_in_monitoring = nn.JoinTable(2)({mem_out_monitoring, hid_comm_monitoring})
    local prev_hid_final_monitoring = nn.Identity()() --8
    g_modules['prev_hid_final_monitoring'] = prev_hid_final_monitoring.data.module
    local prev_cell_final_monitoring = nn.Identity()() --9
    ...
    -----final
    local final_lstm_in_acting = nn.JoinTable(2)({mem_out_acting, hid_comm_acting})
    local prev_hid_final_acting = nn.Identity()() --16
    g_modules['prev_hid_final_acting'] = prev_hid_final_acting.data.module
    local prev_cell_final_acting = nn.Identity()() --17
    ...
    local model = nn.gModule(
        ...
        prev_hid_final_monitoring, --8
        prev_cell_final_monitoring, --9
        mem_state_acting, --10
        prev_mem_out_acting, --11
        prev_hid_context_acting, --12
        prev_cell_context_acting, --13
        prev_hid_comm_acting, --14
        prev_cell_comm_acting, --15
        prev_hid_final_acting, --16
        prev_cell_final_acting},--17
        ...
        hid_final_monitoring, --9
        cell_final_monitoring, --10
        mem_out_acting, --11
        hid_context_acting, --12
        cell_context_acting, --13
        hid_comm_acting, --14
        cell_comm_acting, --15
        hid_final_acting, --16
        cell_final_acting} --17
        )
