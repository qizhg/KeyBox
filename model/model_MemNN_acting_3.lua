...
function g_build_model()
    ...
    comm_in = nn.Identity()() --true matching label
    ...
    local context = comm_in_embeding
    local mem_out = build_model_memnn(context, mem_state)
    ...
    --END acting--
    local model = nn.gModule({mem_state, comm_in}, 
