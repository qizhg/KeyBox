...
function g_build_model()
    ...
    --CAdd
    local comm_in = nn.Identity()() --true matching label
    ...
    local hid_final_acting = nn.CAddTable()({comm_in_embeding, mem_out})
    -----out
    ...
    --END acting--
    local model = nn.gModule({mem_state, dummy_context, comm_in}, 
