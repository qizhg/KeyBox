...
function g_build_model()
    ...
    local hid_acting, cell_acting = build_lstm(input2hid_acting, prev_hid_acting, prev_cell_acting, g_opts.hidsz, g_opts.hidsz)
    ...
    local model = nn.gModule({input_acting, prev_hid_acting, prev_cell_acting}, 
    						 {action_prob_acting, baseline_acting, hid_acting, cell_acting})
    return model
end
