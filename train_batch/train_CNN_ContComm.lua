...
function train_batch(num_batch)
    ...
    local oneshot_monitoring = batch_input_conv_monitoring(batch, active[1], 1)
    ...
    for t = 1, g_opts.max_steps do
        ...
        if g_opts.oneshot_comm == true then 
            ...
            input[t][1] = batch_input_conv_monitoring(batch, active[t], t)
        end
        input[t][2] = batch_input_conv(batch, active[t], t)
